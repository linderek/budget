...
export const BudgetUploadModal: React.FC<BudgetUploadModalProps> = ({
      ...
      if (jsonData.length > 0) {
        ...
        headerRow.forEach((header) => {
          ...
          // Notes mappings
            ...
            ["notes", "comments", "description", "remarks"].includes(
              normalizedHeader
            )
          ) {
    ...
    try {
      ...
      const parsed: ParsedRow[] = rows.map((row, index) => {
        ...
        if (rowData.category) {
          ...
          const validCategory = CATEGORY_LIST.find(
        ...
        if (h1Budget === 0 && h2Budget === 0) {
          errors.push(
            "At least one budget amount (H1 or H2) must be greater than 0"
          );
  ...
  const handleImport = () => {
    ...
    const budgets: Omit<Budget, "id" | "createdAt" | "updatedAt">[] =
      validRows.map((row) => ({
        year: row.year!,
        team: row.team!,
    ...
    const log: ImportLog = {
      ...
      issues: parsedRows
        ...
        .map(
          (row) =>
            `Row ${parseInt(row.id.split("-")[1]) + 2}: ${row.errors.join(
              ", "
            )}`
        ),
    };
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="flex items-center space-x-4">
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    step === "preview" ? "bg-blue-100" : "bg-gray-100"
                  }`}
                >
            ...
            <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-700">
                        Download our sample file to get started
                      </p>
                    </div>
                  </div>
                  <button
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  <p>
                    <strong>Year:</strong> 4-digit year (2020-2030)
                  </p>
                  <p>
                    <strong>Team:</strong> One of: Finance, Marketing, Business
                    Development, Strategy, Product & Engineering, People &
                    Culture, Account Management, Compliance
                  </p>
                  <p>
                    <strong>Category:</strong> Must match existing category list
                  </p>
                  <p>
                    <strong>H1 Budget:</strong> Budget for Jan-Jun (currency)
                  </p>
                  <p>
                    <strong>H2 Budget:</strong> Budget for Jul-Dec (currency)
                  </p>
                  <p>
          ...
          {step === "mapping" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm text-gray-500">File: {file?.name}</div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {["category", "h1Budget", "h2Budget", "notes"].map(
                    (field) => (
                      <div key={field}>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button
                  ...
                  disabled={
                    ...
                    !defaultYear ||
                    defaultYear < 2020 ||
                    (!Object.values(headerMapping).includes("h1Budget") &&
                      !Object.values(headerMapping).includes("h2Budget"))
                  }
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4 text-sm">
                  ...
                  <span className="text-yellow-600">
                    {
                      parsedRows.filter((r) => r.status === "needs-mapping")
                        .length
                    }{" "}
                    Need Mapping
                  </span>
          ...
          {importLog && (
            <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="text-sm text-green-800">
                <p>
                  ✅ Imported {importLog.imported}, skipped {importLog.skipped}{" "}
                  from {importLog.fileName}
                </p>
