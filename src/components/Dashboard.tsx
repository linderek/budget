      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-blue-700">Avg Burn Rate</p>
              <p className="text-2xl font-bold text-blue-900">{formatPercentage(avgBurnRate)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-50 rounded-xl border border-red-200 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-red-700">Largest Overspend</p>
              <p className="text-2xl font-bold text-red-900">
                {largestOverspend === 'None' ? 'None' : `${largestOverspend} ${activeFilters.years[0] || new Date().getFullYear()}`}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 rounded-xl border border-green-200 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium text-green-700">Largest Underspend</p>
              <p className="text-2xl font-bold text-green-900">
                {largestUnderspend === 'None' ? 'None' : `${largestUnderspend} ${activeFilters.years[0] || new Date().getFullYear()}`}
              </p>
            </div>
          </div>
        </div>
